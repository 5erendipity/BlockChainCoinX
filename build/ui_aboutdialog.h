...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About blockchaincoinx", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>blockchaincoinx</b> version", Q_NULLPTR));
...
"Copyright \302\251 2021 The BlockChainCoinX developers", Q_NULLPTR));
